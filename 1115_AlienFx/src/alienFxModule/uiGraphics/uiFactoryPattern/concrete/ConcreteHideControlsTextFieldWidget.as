...
public class ConcreteHideControlsTextFieldWidget extends AbstractTextFieldWidget {
...
//        this.text = vars.text;
        ...
        //***********************************************************************
        //VARS
        var _Copy:String = vars.htmlText;
        var _fontName:String, _className:String;
        _fontName = _className = "PillAlt600mg-Medium";
        ...
        _noFontTextFormatVars.color(0x848488);
        _noFontTextFormatVars.size(12);
        _noFontTextFormatVars.font("_sans");
        _noFontTextFormatVars.align(TextFormatAlign.CENTER);
        ...
        _embeddedFontVARS.color(0x848488);
        _embeddedFontVARS.size(12);
        _embeddedFontVARS.font(_fontName);
        _embeddedFontVARS.align(TextFormatAlign.CENTER);
...
//        if( _className != null && _fontName != null )
        if( _fontName != null )
        {
            ...
            if( _font.hasGlyphs( vars.htmlText ) )
            {
//                trace("embed fonts");
