...
public class SwatchONState implements IState_Swatch {

    private var context:Context_Swatches
    private var target:Swatch;


    public function SwatchONState(_constext:Context_Swatches, _target:Swatch) {
    ...
    public function OFF():void {
        TweenLite.to(target, GlobalAnim.TRANSISITION/1, {strokeAlpha:0});
        context.setState( context.getOFFSwatchState() );
    }

    public function OVER():void {
        TweenLite.to(target, GlobalAnim.TRANSISITION/1, {strokeAlpha:1});
        context.setState( context.getOFFSwatchState() );
    }
}
}
