...
public class SwatchOFFState implements IState_Swatch {

    private var context:Context_Swatches
    private var target:Swatch;


    public function SwatchOFFState(_constext:Context_Swatches, _target:Swatch) {
    ...
    public function OVER():void {
        TweenLite.to(target, GlobalAnim.TRANSISITION/2, {strokeAlpha:1});
        context.setState( context.getOVERSwatchState() );
    }
}
}
