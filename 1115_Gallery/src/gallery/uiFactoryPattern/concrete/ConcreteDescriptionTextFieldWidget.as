 ...
 */
package gallery.uiFactoryPattern.concrete {
...
public class ConcreteDescriptionTextFieldWidget extends AbstractTextFieldWidget {
    ...
    override public function drawWidget(vars:Object = null):void {
        ...
        //***********************************************************************
        //VARS
        var _Copy:String = vars.xmlNode.copy;
...
//        if( _className != null && _fontName != null )
        if( _fontName != null )
        {
            ...
            if( _font.hasGlyphs( vars.xmlNode.copy ) )
            {
//                trace("embed fonts");
