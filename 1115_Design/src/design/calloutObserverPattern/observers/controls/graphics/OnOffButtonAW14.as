...
public class OnOffButtonAW14 extends ConcreteCallOutObserver {
    ...
    public function OnOffButtonAW14(_target:MovieClip,  vars:Object = null) {
        super(vars);
...
//        _labelTextOn = TextUtil.createTextField(ConfigText.TextFieldVars_DesignCaloutLabel.vars);
...
//        ConfigText.TextFieldVars_DesignCaloutLabel.width(0);
//        _labelTextOFF = TextUtil.createTextField(ConfigText.TextFieldVars_DesignCaloutLabel.vars);
...
//        _labelOffBackground.rectHeight = _labelOnBackground.rectHeight = _labelTextOn.height + 10;
        ...
        _unscaledWidth = _labelOffBackground.rectWidth;
