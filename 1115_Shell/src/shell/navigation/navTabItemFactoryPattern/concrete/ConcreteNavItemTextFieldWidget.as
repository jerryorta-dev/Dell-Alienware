...
public class ConcreteNavItemTextFieldWidget extends AbstractTextFieldWidget {
    ...
    override public function drawWidget(vars:Object = null):void {
        ...
        _noFontTextFormatVars.align(TextFormatAlign.RIGHT);
        ...
        _embeddedFontVARS.align(TextFormatAlign.RIGHT);
