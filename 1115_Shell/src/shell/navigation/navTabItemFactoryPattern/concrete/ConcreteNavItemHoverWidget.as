...
public class ConcreteNavItemHoverWidget extends AbstractShapeWidget{
    ...
    override public function drawWidget(vars:Object = null):void {
        ...
        /*
         ...
         if (this.vars.initState == "on") {
         _matrixTx = ConfigShell.MENU_TAB_MATRIX_TX_ON;
         } else {
         _matrixTx = ConfigShell.MENU_TAB_MATRIX_TX_OFF;
         }
         */
    ...
    private function calculatePoints():void {
        ...
        //POINTER TIP
        var pointTip:Point = new Point();
        pointTip.y = verticalCenterOfPointer;
        /*

         if (this.vars.initState == "on") {
         pointTip.x = _rectWidth + _pointWidth;
         } else {
         pointTip.x = _rectWidth;
         }
         */
        ...
        var bp7:Point = new Point(_pointX, _rectHeight);

        points = [bp1, bp2, pointTop, pointTip, pointBottom, bp6, bp7];
        radii = [_radiusRect, _radiusRect, _radiusPoint, _radiusRect, _radiusRect, 0, 0];
        paint();
    }
