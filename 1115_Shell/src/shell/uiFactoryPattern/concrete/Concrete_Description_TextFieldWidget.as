...
public class Concrete_Description_TextFieldWidget extends AbstractTextFieldWidget {

    override public function drawWidget(vars:Object = null):void {
        this.name = vars.name;
        var _Copy:String = vars.subhead;
...
//        if( _className != null && _fontName != null )
        if( _fontName != null )
        {
            ...
            if( _font.hasGlyphs( vars.subhead ) )
            {
//                trace("embed fonts");
