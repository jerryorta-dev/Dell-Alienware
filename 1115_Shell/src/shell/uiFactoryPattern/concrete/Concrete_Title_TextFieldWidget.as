...
public class Concrete_Title_TextFieldWidget extends AbstractTextFieldWidget {
    ...
    override public function drawWidget(vars:Object = null):void {
        ...
        //***********************************************************************
        //VARS
        var _Copy:String = vars.headline;
        ...
        _noFontTextFormatVars.color(0x34fd39);
        _noFontTextFormatVars.size(38);
        ...
        _embeddedFontVARS.color(0x34fd39);
        _embeddedFontVARS.size(38);
...
//        if( _className != null && _fontName != null )
        if( _fontName != null )
        {
            ...
            if( _font.hasGlyphs( vars.headline ) )
            {
//                trace("embed fonts");
