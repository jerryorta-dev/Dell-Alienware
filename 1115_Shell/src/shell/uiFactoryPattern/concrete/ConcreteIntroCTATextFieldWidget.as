...
public class ConcreteIntroCTATextFieldWidget extends AbstractTextFieldWidget {
    ...
    override public function drawWidget(vars:Object = null):void {
        ...
        //***********************************************************************
        //VARS
        var _Copy:String = vars.xmlNode.cta;
        ...
        _noFontTextFormatVars.color(0x000000);
        _noFontTextFormatVars.size(18);
        ...
        _embeddedFontVARS.color(0x000000);
        _embeddedFontVARS.size(18);
...
//        if( _className != null && _fontName != null )
        if( _fontName != null )
        {
            ...
            if( _font.hasGlyphs( vars.xmlNode.cta ) )
            {
//                trace("embed fonts");
